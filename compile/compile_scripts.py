...
Unpyc3PythonCompiler.compile_mod(
    names_of_modules_include=('gtw_club_limits', 'libraries'),
    folder_path_to_output_ts4script_to=ts4_directory,
    output_ts4script_name='gtw_club_limits'
)
